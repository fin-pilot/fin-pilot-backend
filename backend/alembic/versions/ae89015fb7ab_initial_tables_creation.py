...
Revision ID: ae89015fb7ab
Revises:
Create Date: 2026-05-11 00:15:29.040981
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_type",
            sa.Enum("CASH", "CARD", name="accounttype"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_transactions_description"),
        "transactions",
        ["description"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_transactions_description"), table_name="transactions"
    )
