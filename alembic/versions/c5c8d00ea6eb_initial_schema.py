...
Revision ID: c5c8d00ea6eb
Revises: 
Create Date: 2026-05-30 22:56:01.902055
...
def upgrade() -> None:
    ...
    sa.Column('predicted_amount', sa.Numeric(precision=12, scale=2), nullable=False),
